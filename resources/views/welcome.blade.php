        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('img/shop/product-1.jpg')}}">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('img/shop/product-2.jpg')}}">
                        <div class="product__label">
                            <span>Cupcake</span>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('img/shop/product-3.jpg')}}">
                        <div class="product__label">
                            <span>Cupcake</span>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('img/shop/product-4.jpg')}}">
                        <div class="product__label">
                            <span>Cupcake</span>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('img/shop/product-5.jpg')}}">
                        <div class="product__label">
                            <span>Cupcake</span>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('img/shop/product-7.jpg')}}">
                        <div class="product__label">
                            <span>Cupcake</span>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('img/shop/product-8.jpg')}}">
                        <div class="product__label">
                            <span>Cupcake</span>
                        </div>
                    </div>
...
<section class="class spad">
    <div class="container">
        ...
        <div class="class__video set-bg" data-setbg="{{asset('img/class-video.jpg')}}">
...
<section class="team spad">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team__item set-bg" data-setbg="{{asset('img/team/team-4.jpg')}}">
                    <div class="team__item__text">
                        <h6>Randy Butler</h6>
                        <span>Decorater</span>
                        <div class="team__item__social">
